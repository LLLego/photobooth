...
export async function renderDualCamera(mount) {
  ...
  hostStage.className = 'camera-stage aspect-[3/4] w-full mx-auto hidden';
  localVideo = document.createElement('video');
  localVideo.className = 'camera-video';
  localVideo.muted = true;
  localVideo.playsInline = true;
  remoteVideo = document.createElement('video');
  remoteVideo.className = 'absolute top-3 right-3 w-1/3 aspect-[3/4] rounded-2xl border-2 border-warmth-50 shadow-lg object-cover';
  ...
  hostStage.append(localVideo, remoteVideo, overlay, controls);
